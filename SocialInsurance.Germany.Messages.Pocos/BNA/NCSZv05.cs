// <copyright file="NCSZv05.cs" company="DATALINE GmbH &amp; Co. KG">
...
namespace SocialInsurance.Germany.Messages.Pocos.BNA
{
    ...
    /// NCSZ - Nachlaufsatz
    /// </summary>
    public class NCSZv05 : IDatensatz
    {
        /// <summary>
        ...
        /// <summary>
        /// Holt oder stezt das Vorzeichen der Gesamtsumme (<see cref="SUMZAHL"/>)
        /// </summary>
        public string VORZEGES { get; set; }

        /// <summary>
        /// Holt oder setzt die Gesamtsumme
        /// </summary>
        public long SUMZAHL { get; set; }
        ...
        /// <summary>
        /// Holt oder setzt das Satzendezeichen
        /// </summary>
