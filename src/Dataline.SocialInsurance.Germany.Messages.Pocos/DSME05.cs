// <copyright file="DSME05.cs" company="DATALINE GmbH &amp; Co. KG">
...
namespace SocialInsurance.Germany.Messages.Pocos
{
    ...
    /// </summary>
    public class DSME05 : IDatensatz
    {
        ...
        /// <summary>
        /// Holt oder setzt die Absendernummer
        /// </summary>
        /// <remarks>
        /// <list type="bullet">
        ///     <item>Betriebsnummer des Absenders der Datei (8 Stellen linksbündig mit nachfolgenden Leerzeichen), Länge 15, Mussangabe</item>
        ...
        /// </list>
        /// <para>
        /// Die Grundstellung (Leerzeichen) ist nur bei folgenden Meldungen zulässig:
        /// </para>
        /// <list type="bullet">
        ///     <item>wegen der Schließung der Mitgliedschaft durch die Krankenkasse (Abgabegrund 94 oder 95) oder</item>
        ///     <item>mit Personengruppen ungleich 1nn (Stelle 1 im Feld PERSGR ungleich 1)</item>
        /// </list>
        /// </remarks>
        public string ABSNRV { get; set; }
        ...
        public DBBM05 DBBM
        {
            get => ListeDBBM?.SingleOrDefault();
            set
            {
                ListeDBBM = ListeDBBM.Set(value);
                _hatDbbm = null;
            }
        }
        ...
        public IEnumerable<IDatenbaustein> Datenbausteine
        {
            get
            {
                foreach (var datenbaustein in ListExtensions.Enumerate(ListeDBME, ListeDBNA, ListeDBGB, ListeDBAN, ListeDBEU, ListeDBUV))
                    yield return datenbaustein;
                if (DBKS != null)
                    yield return DBKS;
                foreach (var datenbaustein in ListExtensions.Enumerate(ListeDBSO, ListeDBKV, ListeDBSV, ListeDBVR, ListeDBRG, ListeDBBM, DBFE))
                    yield return datenbaustein;
            }
        }

        private IList<DBME05> ListeDBME { get; set; }
        ...
        private IList<DBBM05> ListeDBBM { get; set; }
