...
namespace SocialInsurance.Germany.Messages.Pocos.AAG
{
    ...
    public class DSER05 : IDatensatz
    {
        ...
        public bool FEKZ
        {
            get { return _fekz ?? DBFE != null && DBFE.Count != 0; }
            set { _fekz = value; }
        }
        ...
        public DBAU05 DBAU
        {
            get
            {
                return ListeDBAU?.SingleOrDefault();
            }
            set
            {
        ...
        public DBBT05 DBBT
        {
            get
            {
                return ListeDBBT?.SingleOrDefault();
            }
            set
            {
        ...
        public DBZU04 DBZU
        {
            get
            {
                return ListeDBZU?.SingleOrDefault();
            }
            set
            {
        ...
        public DBBV DBBV
        {
            get
            {
                return ListeDBBV?.SingleOrDefault();
            }
            set
            {
        ...
        public DBAA DBAA
        {
            get
            {
                return ListeDBAA?.SingleOrDefault();
            }
            set
            {
