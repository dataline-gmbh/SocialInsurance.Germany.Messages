// <copyright file="BW0212.cs" company="DATALINE GmbH &amp; Co. KG">
...
namespace SocialInsurance.Germany.Messages.Pocos.BNA
{
    ...
    /// </summary>
    public class BW0212 : IDatensatz
    {
        ...
        /// <summary>
        /// Holt oder setzt das Insolvenzkennzeichen
        /// </summary>
        /// <remarks>
        /// 0 = Grundstellung
        /// 1 = Beitragsnachweis fuer freigestellte Arbeitnehmer
        /// Länge 1, Mussangabe
        /// </remarks>
        public int KEINSBN { get; set; }
