// <copyright file="DSBE03.cs" company="DATALINE GmbH &amp; Co. KG">
...
namespace SocialInsurance.Germany.Messages.Pocos
{
    ...
    /// </summary>
    public class DSBE03 : IDatensatz
    {
        ...
        /// <summary>
        /// Initialisiert eine neue Instanz der <see cref="DSBE01"/> Klasse
        /// </summary>
        /// <remarks>
        ...
        public IEnumerable<IDatenbaustein> Datenbausteine
        {
            get
            {
                foreach (var datenbaustein in ListExtensions.Enumerate(ListeDBBF, ListeDBMI, ListeDBHB, DBFE))
