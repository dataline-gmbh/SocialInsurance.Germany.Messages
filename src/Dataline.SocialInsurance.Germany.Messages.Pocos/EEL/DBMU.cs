// <copyright file="DBMU.cs" company="DATALINE GmbH &amp; Co. KG">
...
namespace SocialInsurance.Germany.Messages.Pocos.EEL
{
    ...
    /// </summary>
    public class DBMU : IDatenbaustein
    {
        /// <summary>
        ...
        /// <summary>
        /// Holt oder setzt den letzten bezahlten Tag vor der Entbindung.
        /// </summary>
        ...
        /// <summary>
        /// Holt oder setzt, ob die Arbeitnehmerin ein Monatsgehalt/festes Monatsentgelt bezieht.
        /// </summary>
        public bool AEFEST { get; set; }
